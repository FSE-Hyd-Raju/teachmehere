...
import SkillDetails from '../../components/SkillComponents/SkillDetails';
...
class SkillDetailsScreen extends React.Component {
...
export default withDelayedLoading(SkillDetailsScreen);
