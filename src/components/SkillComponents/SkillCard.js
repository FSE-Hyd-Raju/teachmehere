...
class SkillCard extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      isFolded: true,
      ...
      <View>
        ...
        >
          <View style={{ padding: Theme.spacing.small }}>
            <SkillScoreYear skill={skill} style={{ marginBottom: Theme.spacing.tiny }} />
            <AppText numberOfLines={12}>{skill.overview}</AppText>
          </View>
        </Animated.View>
      </View>
    );
