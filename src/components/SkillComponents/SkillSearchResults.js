...
import SkillFetchList from './SkillFetchList';
import { getEmptySearchIcon, getInitialSearchIcon } from '../../utils/icons';
import Theme from '../../Theme';

class SkillSearchResult extends React.PureComponent {
  renderEmptyResults = () => (
    <InfoAbsoluteBlock
  ...
  renderInitialMessage = () => (
    <InfoAbsoluteBlock
      ...
      text="Search"
      subtext="Find your favorite skills"
    />
  );
