...
class SkillsHorizontalScroll extends React.PureComponent {
  onMorePress = () => {
    const { title, fetchFunction, navigation } = this.props;
    navigation.push(RouteNames.SkillListScreen, { title, fetchFunction });
  };

  render() {
    const { title, skills, style } = this.props;
    return (
